package com.jiacyer.newpaydemo.view;
...
//    private TextView mFootTextView;
    ...
    public ListViewFooter(Context context, ListView listView) {
        super(context);
        parent = listView;
        initView(context);
    }
...
//        mFootTextView.setVisibility(View.GONE);
    ...
    private void initView(Context context) {
        mContext = context;
        LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.layout_listview_footer, parent, false);
        addView(moreView);
