...
public class QRCodeFactory {
    ...
    public BufferedImage setMatrixLogo(BufferedImage matrixImage,String logUri) throws IOException{
         ...
         * 读取Logo图片
         */
        BufferedImage logo = ImageIO.read(QRCodeFactory.class.getResourceAsStream(logUri));
     ...
     */
    public void CreateQrImage(String content, String format, String outFileUri, String logUri, int ...size) throws IOException, WriterException{
    ...
    public BufferedImage CreateQrBufferedImage(String content, String logUri, int ...size) throws IOException, WriterException{
        ...
        return MatrixToImageWriter.writeToBufferedImage(bitMatrix, logUri);
    }
}
